...
/**
 * *********************************************
 * created on 22.06.2006 last modified:
 *
 * author:	sstein
 *
 * description: contains some method to extract sets of features which fullfill
 * some spatial criterion
 *
 **********************************************
 */
...
/**
 *
 * contains some method to extract sets of features which fullfill some spatial
 * criterion<p> notes:<p> - use "intersects" only for polygon geometries
 * (condition intersection area > 0).<p> - "contains" can be used for polygons
 * and points (centroid from polygon is calculated)<p>
 *
 * @author sstein
 *
 */
public class SpatialRelationOp {
    ...
    /**
     * note: if input feature is point and spatial attribute is "intersect" or
     * "covered by" the candidate features are selected from a 10.0m radius
     *
