/**
 * *********************************************
 * created on 14.09.2005 last modified:
 *
 * author:	sstein
 *
 * description: merges two polygon and returns the result via getOutPolygon() if
 * the result is not of another geometry type. The merge is done with the JTS
 * union() method.
 **********************************************
 */
...
/**
 * Merges two polygon and returns the result via getOutPolygon() if the result
 * is not of another geometry type. The merge is done with the JTS union()
 * method.
 *
 * @author sstein
 *
...
public class PolygonMerge {
    ...
    /**
     * @return Returns the mergeSuccesfull.<p> 0: polys dont touch, 1:
     * sucessfull, 2: polys touch but only with one point on line. thus a
     * multipolygon is created.
     */
