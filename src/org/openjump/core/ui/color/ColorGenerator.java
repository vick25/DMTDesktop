...
/**
 * Class to generate a given number of color steps to cross fade from color A to
 * color C (and optionally pass color B)
 *
...
public class ColorGenerator {
    ...
    /**
     * this constructor is untested, yet (but there is no predictable reason,
