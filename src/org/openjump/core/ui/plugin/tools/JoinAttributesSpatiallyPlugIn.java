...
/**
 * ***************************************************
 * created: 22.06.2006 last modified:
 *
 * @author sstein
 *
...
public class JoinAttributesSpatiallyPlugIn extends ThreadedBasePlugIn {
    ...
    public static MultiEnableCheck createEnableCheck(WorkbenchContext workbenchContext) {
        ...
        return new MultiEnableCheck()
                ...
                .add(checkFactory.createAtLeastNLayersMustExistCheck(2)) /*.add(checkFactory.createAtLeastNItemsMustBeSelectedCheck(2)*)*/;
    }
    ...
    private void setDialogValues(MultiInputDialog selectTypeDialog2, PlugInContext context) {
        ...
        //-- target layer
        if (targetLayer == null) {
            targetLayer = context.getCandidateLayer(0);
        }
    ...
    private void updateUIForAttributes() {
        ...
        if (model.getSize() == 0) {
            //Can get here if the only attribute is the geometry. [Bob Boseko]
        }
    ...
    private void generateOpLists() {
        ...
        /**
         * copy from AttributeOp public final static int MAJORITY = 0; public final static int
