...
/**
 * ***************************************************
 * created: 05.06.2006 last modified:
 *
 * @author sstein
 *
 * description: creates voronoi regions/thiessen polygons from a set of points. The Delauney
 * algorithm used for the triangulation is by L. Paul Chew and his free demonstration
 * java-applet.<p>
...
/**
 * Creates voronoi regions from a set of points. The Delauney algorithm used for the triangulation
 * is by L. Paul Chew and his free demonstration java-applet.<p>
