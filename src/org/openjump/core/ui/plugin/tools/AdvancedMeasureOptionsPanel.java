...
import com.osfac.dmt.workbench.model.MeasureLayerFinder;
import com.osfac.dmt.workbench.ui.FontChooser;
...
/**
 * This Panel displays the options for the AdvancedMeasureTool. The options are:
 * - Summary - display area and distance? - font and size - font color - vertex
 * - display distance per vertex? - font and size - font color - paint vertex? -
 * vertex style for the first vertex and the following vertexes - line and fill
 * style - paint line? - linecolor - paint fill? - fillcolor
 *
 *
 * @author Matthias Scholz <ms@jammerhund.de>
 */
public class AdvancedMeasureOptionsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        paintSummaryLengthCheckBox.setFocusable(false);
        paintSummaryAreaCheckBox.setFocusable(false);
        ...
        paintSummaryLengthCheckBox.addItemListener(new ItemListener() {
            @Override
        ...
        paintSummaryAreaCheckBox.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (start) {
                    SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
        ...
        summaryFontButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Font newFont = FontChooser.showDialog(Config.optionsDialog, I18N.get(""
                        + "org.openjump.core.ui.plugin.tools.AdvancedMeasureOptionsPanel.choose-font"), summaryFont, true);
                if (newFont != null) {
                    SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
                    summaryFont = newFont;
                }
        ...
        summaryFontColorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
                summaryFontColor = JColorChooser.showDialog(Config.optionsDialog, I18N.get("org.openjump.core.ui.plugin.tools.AdvancedMeasureOptionsPanel.choose-color"), summaryFontColor);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        paintVertexDistanceCheckBox.setFocusable(false);
        ...
        paintVertexDistanceCheckBox.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (start) {
                    SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
        ...
        vertexFontButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Font newFont = FontChooser.showDialog(Config.optionsDialog, I18N.get("org.openjump.core.ui.plugin.tools.AdvancedMeasureOptionsPanel.choose-font"), vertexFont, true);
                if (newFont != null) {
                    SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
                    vertexFont = newFont;
                }
        ...
        vertexFontColorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
                vertexFontColor = JColorChooser.showDialog(Config.optionsDialog, I18N.get("org.openjump.core.ui.plugin.tools.AdvancedMeasureOptionsPanel.choose-color"), vertexFontColor);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        vertexStyleButton.setFocusable(false);
        ...
        vertexStyleButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // create the dialog
                OKCancelDialog vertexStyleDialog = new OKCancelDialog(Config.optionsDialog,
        ...
        lineColorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
                lineColor = JColorChooser.showDialog(Config.optionsDialog, I18N.get("org.openjump.core.ui.plugin.tools.AdvancedMeasureOptionsPanel.choose-color"), lineColor);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        fillColorButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                SettingOptionsDialog.page.fireButtonEvent(ButtonEvent.ENABLE_BUTTON, ButtonNames.APPLY);
                fillColor = JColorChooser.showDialog(Config.optionsDialog, I18N.get("org.openjump.core.ui.plugin.tools.AdvancedMeasureOptionsPanel.choose-color"), fillColor);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
    ...
    public final void init() {
        ...
        if (color instanceof Color) {
            vertexStylePanelFirst.setVertexColor((Color) color);
        }
        string = blackboard.get(BB_VERTEX_FIRST_FORM, DEFAULT_VERTEX_FIRST_FORM);
        if (string instanceof String) {
            vertexStylePanelFirst.setVertexForm((String) string);
        }
        ...
        if (color instanceof Color) {
            vertexStylePanelFollowing.setVertexColor((Color) color);
        }
        string = blackboard.get(BB_VERTEX_FOLLOWING_FORM, DEFAULT_VERTEX_FOLLOWING_FORM);
        if (string instanceof String) {
            vertexStylePanelFollowing.setVertexForm((String) string);
        }
