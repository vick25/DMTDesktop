...
public class ConstraintsOptionsPanel extends JPanel {
    ...
    public ConstraintsOptionsPanel(WorkbenchContext workbenchContext) {
        ...
        relativeAngleRadioButton.addItemListener(new ItemListener() {
            @Override
        ...
        lengthCheckBox.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                updateEnabled();
            }
        });
        constrainIncrementalAngleCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                updateEnabled();
            }
        });
        constrainAngleCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                updateEnabled();
            }
        });
