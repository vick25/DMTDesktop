...
import com.osfac.dmt.workbench.ui.cursortool.AbstractCursorTool;
...
//    private LayerViewPanel panel;
    ...
    public void cancelGesture() {
        ...
        //      the points haven't been cleared. [Bob Boseko]
...
//        }
    ...
    public void mouseReleased(MouseEvent e) {
        try {
            ...
            //the clickCount=2 event, coordinates is empty! [Bob Boseko]
            ...
            //calls #isGestureInProgress. [Bob Boseko]
            ...
            //resulting in an IndexOutOfBoundsException in #redrawShape. [Bob Boseko]
...
//        }
    ...
    protected Shape getShape() throws NoninvertibleTransformException {
        ...
        for (int i = 1; i < coordinates.size(); i++) { //start 1 [Bob Boseko]
    ...
    protected void finishGesture() throws Exception {
        ...
        try {
            ...
            //If exception occurs, cancel. [Bob Boseko]
            coordinates.clear();
        }
    }
