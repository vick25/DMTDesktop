...
public class CutPolygonTool extends PolygonTool {
	...
	protected void gestureFinished() throws Exception {
	    ...
	    if (selectedLayers.length == 0){
			JOptionPane.showMessageDialog(null, I18N.getMessage("com.osfac.dmt.workbench.plugin.At-least-one-layer-must-be-selected", new Object[]{1}),  I18N.get("org.openjump.core.ui.plugin.edittoolbox.Information"), JOptionPane.INFORMATION_MESSAGE);
	    }
	    
	    else if (selectedLayers.length > 1) {
	        JOptionPane.showMessageDialog(null,  I18N.getMessage("com.osfac.dmt.workbench.plugin.Exactly-one-layer-must-have-selected-items", new Object[]{1}),  I18N.get("org.openjump.core.ui.plugin.edittoolbox.Information"), JOptionPane.INFORMATION_MESSAGE);
	    }
