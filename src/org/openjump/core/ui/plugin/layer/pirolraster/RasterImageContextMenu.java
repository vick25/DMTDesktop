...
import com.osfac.dmt.workbench.ui.TitledPopupMenu;
...
public class RasterImageContextMenu extends TitledPopupMenu {
    ...
    /**
     * use this method to get an instance of the context menu. The menu will be
     * instantiated when this method is called the first time.
     *
