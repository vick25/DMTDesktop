...
public class LayerPropertiesPlugIn extends AbstractPlugIn {
    ...
    private class InfoPanel extends JPanel implements PropertyPanel {
        ...
        private InfoPanel() {
            ...
            if (layers.length == 1
                    ...
                    && layers[0].getDataSourceQuery().getDataSource().getClass().getName().equals("com.osfac.dmt.io.datasource.StandardReaderWriterFileDataSource$Shapefile")) {
    ...
    private class StylePanel extends JPanel implements PropertyPanel {
        ...
        private StylePanel() {
            ...
            transparencySlider.setFocusable(false);
