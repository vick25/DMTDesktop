 ...
 * objects will be created, if neccessary<br> - you don't need to access the
 * properties map of the data source (where the meta information is stored)
 * yourself<br>
 *
...
public class MetaInformationHandler implements HandlerToMakeYourLifeEasier {
    ...
    /**
     *
     * @param layerWithMetaInformation the layer you want the meta information
     * of (has to have a DataSource!!)
     */
    ...
    /**
     *
     * @param objectWithMetaInformation the object you want the meta information
     * of
     */
     ...
     *
     * @return the existent meta information map or an empty meta information
     * map (that is now attached to the DataSource)
     * @throws RuntimeException, if the given DataSource doesn't even have
    ...
    /**
     * @return true if the given layer already contains meta information, false
     * if not
     */
    ...
    /**
     * Adds a new meta information key-value-pair to the meta information map,
     * replaces an existing pair with the same key.
     *
     * @param key
     * @param value
     */
    ...
    /**
     * @return the Attribute2UnitMap of the given DataSource or null, if there
     * is none
     */
