...
import com.osfac.dmt.io.EndianDataOutputStream;
...
/**
 * This class represents an ESRI Shape file.<p> You construct it with a file
 * name, and later you can read the file's properties, i.e. Sizes, Types, and
 * the data itself.<p> Copyright 1998 by James Macgill. <p>
 *
 * Version 1.0beta1.1 (added construct with inputstream) 1.0beta1.2 (made Shape
 * type constants public 18/Aug/98)
 *
 * This class supports the Shape file as set out in :-<br> <a
 * href="http://www.esri.com/library/whitepapers/pdfs/shapefile.pdf"><b>"ESRI(r)
 * Shapefile - A Technical Description"</b><br> <i>'An ESRI White Paper . May
 * 1997'</i></a><p>
 *
...
public class Shapefile {
     ...
     * @param ShapeFileDimension shapefile dimension (2=x,y ; 3=x,y,m ;
     * 4=x,y,z,m)
     */
     ...
     *
     * @param geom the geom
     * @param ShapeFileDimension the dimension of the geom (2=x,y ; 3=x,y,m ;
     * 4=x,y,z,m)
