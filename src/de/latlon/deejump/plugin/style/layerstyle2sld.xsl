...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="style">
    <xsl:if test="@class='com.osfac.dmt.workbench.ui.renderer.style.BasicStyle'">
    ...
    <xsl:if test="@class='com.osfac.dmt.workbench.ui.renderer.style.ColorThemingStyle'">
      <xsl:if test="@enabled='true'">
        <xsl:apply-templates select="attribute-value-to-style-map"/>
      </xsl:if>
    </xsl:if>
    <!-- label style -->
    <xsl:if test="@class='com.osfac.dmt.workbench.ui.renderer.style.LabelStyle'">
      <xsl:if test="@enabled='true'">
        <sld:Rule>
  ...
  <xsl:template match="attribute-value-to-style-map/mapping" name="rules">
    <sld:Rule>
      ...
      <xsl:if test="../@class='com.osfac.dmt.util.Range$RangeTreeMap'">
        ...
        <ogc:Filter>
          <ogc:PropertyIsBetween>
            ...
            <ogc:UpperBoundary>
              <ogc:Literal>
                <xsl:choose>
                  <xsl:when test="./key/max/@class='com.osfac.dmt.util.Range$PositiveInfinity'">999999999</xsl:when>
                  <xsl:when test="./key/max/@class='com.osfac.dmt.util.Range$NegativeInfinity'">-999999999</xsl:when>
                  <xsl:otherwise>
  ...
  <xsl:template match="fill">
    <xsl:if test="@enabled='true'">
      <sld:Fill>
        <xsl:choose>
          <xsl:when test="pattern/@class='com.osfac.dmt.workbench.ui.renderer.style.ImageFillPattern' and pattern/@enabled='true'">
          ...
          <xsl:when test="pattern/@class='com.osfac.dmt.workbench.ui.renderer.style.WKTFillPattern' and pattern/@enabled='true'">
