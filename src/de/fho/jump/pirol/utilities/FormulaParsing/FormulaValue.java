 ...
 *  $Author: javamap $
 *  $Rev: 856 $
 *  $Date: 2007-06-19 06:15:27 +0200 (mar., 19 juin 2007) $
...
/**
 * Base class for each sub-formula or value of a formula, since we don't want to
 * parse the formula again and again for each value...
 *
...
public abstract class FormulaValue {
    ...
    /**
     * Returns the value (as a double) of this part of the formula. It may be
     * the rsult of a sub-formula, a feature-specific attribute value or just a
     * constant value... Since the value may depend on a feature, we give the
     * feature to the method to get a unified interface...
     *
