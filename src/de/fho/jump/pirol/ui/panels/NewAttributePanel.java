...
/**
 *
 * A Panel that contains controls to collect all information needed to create a
 * new attribute out of. The following information will be collected:<br> -name
 * of the attribute<br> -type of the attribute values<br> -Default-value (will
 * initially filled in all features)<br>
 *
...
public class NewAttributePanel extends JPanel implements ActionListener {
    ...
    /**
     * @param arg0 see JPanel for information
     * @param onlyTypes array of attribute type, that are supposed to be
     * chooseable
     * @param needDefaultValue a field for a default value will be shown or not
     */
    ...
    /**
     * Sets the text that will be displayed in the text field for the new
     * attribute's name.
     *
    ...
    /**
     * Returns the collected information on the new attribute. Since this method
     * calls getDefaultValue(), it may throw the same Exception...
     *
    ...
    /**
     * This allows you to check, if the data filled in by the user makes sense
     * or not. You may want enable/disable the ok-button, depending on the
    ...
    /**
     * Returns the default value for the attribute we want to create. This
     * function may throw a RuntimeException, if the value filled in for the
     * default value can not be parsed!
     *
