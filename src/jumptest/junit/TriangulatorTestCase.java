...
import com.osfac.dmt.warp.Quadrilateral;
import com.osfac.dmt.warp.TaggedCoordinate;
import java.util.*;
...
public class TriangulatorTestCase extends TestCase {
    ...
    public void testContains2() {
        //Demonstrates that Saalfeld's point-in-triangle test is not robust. [Bob Boseko]
        Triangle t =
            new Triangle(
