...
public class AbstractPlugInTestCase extends TestCase {
  ...
  public void testGetName() {
    assertEquals(
        ...
        p.toFriendlyName("package com.osfac.dmt.workbench.ui.plugin.test.GenerateTestLayersPlugIn"));
    assertEquals(
        "Add Layer",
        p.toFriendlyName("com.osfac.dmt.workbench.ui.plugin.AddLayerPlugIn"));
    assertEquals(
        "Generate BIT Transform",
        p.toFriendlyName("package com.osfac.dmt.workbench.ui.plugin.test.GenerateBITTransform"));
    assertEquals(
        "",
        p.toFriendlyName(""));
    assertEquals(
