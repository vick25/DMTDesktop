...
import irepport.view.save.JRPrintSaveContributor;
import java.awt.*;
...
public final class JRViewer extends javax.swing.JPanel implements JRHyperlinkListener {
    ...
    protected int defaultZoomIndex = 0;
    ...
    protected void initResources(Locale locale, ResourceBundle resBundle) {
        ...
        if (resBundle == null) {
            this.resourceBundle = ResourceBundle.getBundle("irepport/view/viewer", getLocale());
        } else {
    ...
    protected void initSaveContributors() {
        final String[] DEFAULT_CONTRIBUTORS = {
            "irepport.view.save.JRPdfSaveContributor",
            "irepport.view.save.JRDocxSaveContributor",
            "irepport.view.save.JRSingleSheetXlsSaveContributor",
            "irepport.view.save.JRMultipleSheetsXlsSaveContributor",};
            ...
            Thread thread = new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, getBundleString("error.printing"));
                    } finally {
    ...
    protected void setPageImage() {
        ...
        if (pageError) {
            ...
            try {
                ...
                image = getPageErrorImage();
                JOptionPane.showMessageDialog(this, java.util.ResourceBundle.getBundle("irepport/view/viewer").getString("error.displaying"));
            }
        }
    ...
    protected void paintPage(Graphics2D grx) {
        ...
        try {
            ...
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    JOptionPane.showMessageDialog(null, getBundleString("error.displaying"));
                }
            });
        }
