...
public class IconLoader extends Component {
    ...
    public Image load(String name) {
        ...
        if (debug) {
            System.out.println("Loading from jar: " + filename);
        }
        try {
            ...
            if (debug) {
                System.out.println("Error opening Jar file from URL, trying local file: " + e);
            }
            try {
                String fname = "";
                ...
                if (debug) {
                    System.out.println("Loading icon from GIF");
                }
