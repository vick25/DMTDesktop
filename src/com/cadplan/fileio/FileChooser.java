...
/**
 * User: geoff Date: 5/04/2006 Time: 12:54:42 Copyright 2005 Geoffrey G Roy.
 */
public class FileChooser {
    ...
    public FileChooser(Component parent, String defaultDirName, String defaultFileName,
        ...
        if (defaultDirName == null) {
            dir = new File(props.getProperty("user.dir"));
        } else {
            dir = new File(defaultDirName + File.separator);
        }
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (type == JFileChooser.SAVE_DIALOG) {
                fileName = addExtension(fileName, filterText);
            }
...
class MyFileFilter extends FileFilter {
    ...
    public MyFileFilter(String description, String[] extensions) {
        if (description == null) {
            this.description = "Files like: " + extensions[0];
        } else {
