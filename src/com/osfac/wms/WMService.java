...
public class WMService {
    ...
    /**
     * Connect to the service and get the capabilities. This must be called
     * before anything else is done with this service.
     *
     * @param alertDifferingURL alert the user if a different GetMap URL is
     * available
     * @throws IOException
     */
