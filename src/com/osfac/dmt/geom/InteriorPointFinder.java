...
public class InteriorPointFinder {
    ...
    //<<TODO:REFACTORING>> Move this class to JTS [Bob Boseko]
    ...
    public Coordinate findPoint(Geometry geometry) {
        if (geometry.isEmpty()) {
            //Can't use geometry#getPoint because it returns null [Bob Boseko]
            return new Coordinate(0, 0);
        }

        if (geometry.getDimension() == 0) {
            //Points and multipoints [Bob Boseko]
    ...
    public Coordinate centre(Envelope envelope) {
        //<<TODO:REFACTORING>> Move #avg from GUIUtilities to a core JCS util class [Bob Boseko]
