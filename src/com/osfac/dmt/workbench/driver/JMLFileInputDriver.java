 ...
 * @version 1.0
 *
 * <p>Title: JMLFileInputDriver</p> <p>Description: Input Driver for JML type of
 * files</p> <p>Copyright: Copyright (c) 2002</p> <p>Company: Vivid Solutions
 * Inc.</p>
 *
 *
 */
public class JMLFileInputDriver extends AbstractInputDriver {
    ...
    public void input(LayerManager layerManager, String categoryName)
            ...
            com.osfac.dmt.io.IllegalParametersException, Exception {
        String extension;
        ...
        if (extension.equalsIgnoreCase("zip")) {
            ...
            internalName = CompressedFile.getInternalZipFnameByExtension(".dmt",
                    name);
            ...
            if (internalName == null) {
                throw new Exception(
                        "Couldnt find a .dmt, .xml, or .gml file inside the .zip file: "
                        + name);
            }
