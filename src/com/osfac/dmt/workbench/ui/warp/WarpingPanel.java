...
import com.osfac.dmt.warp.CoordinateTransform;
import com.osfac.dmt.warp.DummyTransform;
import com.osfac.dmt.warp.BilinearInterpolatedTransform;
...
import com.osfac.dmt.workbench.ui.plugin
    .CopySelectedLayersToWarpingVectorsPlugIn;
import com.osfac.dmt.workbench.ui.plugin.generate.ShowTriangulationPlugIn;
import com.osfac.dmt.workbench.ui.toolbox.ToolboxDialog;

public class WarpingPanel extends JPanel {

    //This class is huge -- could do with some refactoring! [Bob Boseko]
    ...
    private void addModificationListener(final Layer outputLayer) {
        outputLayer.getLayerManager().addLayerListener(new LayerListener() {
            ...
            public void layerChanged(LayerEvent e) {
                ...
                //Unlike feature changes! [Bob Boseko]
            }
    ...
    void clearOutputButton_actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            //(i.e. if user manually modifies the vectors). [Bob Boseko]
            ...
            UndoableCommand command =
                ...
                public void execute() {
                    ...
                    if (outputLayerExistedOriginally) {
                        ...
                        //will be generated by #warp. [Bob Boseko]
                        toolbox.getContext().getLayerManager().remove(
                ...
                public void unexecute() {
                    //Triangulation layer undo is handled by ShowTriangulationPlugIn#addUndo. [Bob Boseko]
                    try {
                        if (willShowSourceLayer) {
    ...
    private void clearWarpingFlag() {
        ...
        //i.e. don't end the window prematurely. [Bob Boseko]
    ...
    private Layer outputLayer(String sourceLayerName) {
        ...
        if (outputLayer.getBlackboard().get(MODIFIED_OUTSIDE_WARP_KEY) == null) {
            //Handles case in which the user has created a layer named "Warp Output". [Bob Boseko]
            outputLayer.getBlackboard().put(MODIFIED_OUTSIDE_WARP_KEY, true);
    ...
    private Collection toWarpingVectors(
        ...
        //just got reconstruction vectors. [Bob Boseko]                        
        ...
        for (Iterator i = incrementalWarpingVectors.iterator(); i.hasNext();) {
            ...
            if (tail.equals(tip) && reconstructionVectorTips.contains(tip)) {
                ...
                //alrady been added above. [Bob Boseko]
                continue;
            }
    ...
    public UndoableCommand addWarpingVectorGeneration(final UndoableCommand wrappeeCommand)
        ...
        return new UndoableCommand(wrappeeCommand.getName()) {
            ...
            //addRelativeVectorCommand execute first. [Bob Boseko]
