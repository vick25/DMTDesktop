...
public class GUIUtil {
    ...
    //supposed to be very generic. [Bob Boseko]
    public final static String jml = "dmt";
     ...
     *
     * <p> Based on code from Jason Sherman. See
     * http://www.w3schools.com/html/html_asciiref.asp </p>
     */
    ...
    public static void chooseGoodColumnWidths(JTable table) {
        ...
        for (int i = 0; i < table.getModel().getColumnCount(); i++) {
            ...
            //up a bit less than the preferred width. [Bob Boseko]
        ...
        public void approveSelection() {
            ...
            if (selectedFile.exists()
                ...
                int response = JOptionPane.showConfirmDialog(this,
                        ...
                        "OSFAC-DMT", JOptionPane.YES_NO_OPTION);
    ...
    public static void handleThrowable(final Throwable t, final Component parent) {
        try {
            ...
            //"Humane Interfaces" (Raskin 2000) [Bob Boseko]
    ...
    public static Color toSimulatedTransparency(Color color) {
        //My guess, but it seems to work! [Bob Boseko]
        return new Color(
                color.getRed()
    ...
    public static void setLocation(Component componentToMove, Location location, Component other) {
        WorkbenchFrame._documentPane.setActiveDocument(I18N.get("Text.Geographic-Search"));
        Point p = new Point(
     ...
     * nothing when a file is selected" [Bob Boseko]
     */
    public static File[] selectedFiles(JFileChooser chooser) {
        return ((chooser.getSelectedFiles().length == 0) && (chooser
                .getSelectedFile() != null)) ? new File[]{chooser.getSelectedFile()} : chooser.getSelectedFiles();
    }
     ...
     */
    public static void dispose(final JInternalFrame internalFrame, JDesktopPane desktopPane) {
    ...
    public static class Location {
         ...
         *
         * @param fromBottom whether y is the number of pixels between the
         * bottom edges of the toolbox and desktop pane, or between the top
         * edges.
         */
