...
/**
 * A JPanel that allows the user to move Object's back and forth between two
 * JList's.
 */
public class AddRemovePanel extends JPanel {
    ...
    private void initLabelSizes() {
        //Ensure left and right sides have same width [Bob Boseko]
        Dimension d =
                new Dimension(
                (int) Math.max(
    ...
    private void init(AddRemoveList list, JScrollPane scrollPane) {
        ...
        //sure their preferred sizes are initially the same. [Bob Boseko]
