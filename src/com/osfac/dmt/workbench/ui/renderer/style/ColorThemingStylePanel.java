...
import com.osfac.dmt.workbench.ui.EnableableToolBar;
import com.osfac.dmt.workbench.ui.GUIUtil;
import com.osfac.dmt.workbench.ui.OKCancelPanel;
import com.osfac.dmt.workbench.ui.images.IconLoader;
import com.osfac.dmt.workbench.ui.renderer.style.attributeclassifications.JenksBreaksColorThemingState;
import com.osfac.dmt.workbench.ui.renderer.style.attributeclassifications.MaximalBreaksColorThemingState;
import com.osfac.dmt.workbench.ui.renderer.style.attributeclassifications.MeanSTDevColorThemingState;
import com.osfac.dmt.workbench.ui.renderer.style.attributeclassifications.QuantileColorThemingState;
import com.osfac.dmt.workbench.ui.renderer.style.attributeclassifications.RangeColorThemingState;
import com.osfac.dmt.workbench.ui.style.BasicStylePanel;
...
/**
 * A panel to choose Color Theming options. The panel includes <ul> <li>a
 * checkbox to enable Color Theming</li> <li>a combobox to choose Attribute</li>
 * <li>a combobox to choose Classification Method plus additional parameters in
 * case of range-based classification</li> <li>a combobox to choose a Color
 * Scheme</li> <li>an table to display colors with two plugins to add/remove
 * lines</li> <li>a slider to set the transparency</li> </ul>
 *
 * @author </p>jonathan aquino (original author)
 * @author </p>obedel and ebocher (2005 - added Quantile Color Theming)
 * @author </p>ssteiniger (2009 - added 3 more range-based classification
 * methods)
...
public class ColorThemingStylePanel extends JPanel implements StylePanel {
    ...
    private TableCellEditor basicStyleTableCellEditor = new TableCellEditor() {
        ...
        public Component getTableCellEditorComponent(JTable table,
            ...
            //will not show up as the selected item in the combo box. [Bob Boseko]
    ...
    public ColorThemingStylePanel(Layer layer, WorkbenchContext workbenchContext) {
        ...
        try {
            ...
            //Must set state early so that #initTable can call #fromExternalFormat. [Bob Boseko]
    ...
    private void updateComponents() {
        ...
        try {
            ...
            //Give the "Cannot colour-theme layer" message priority. [Bob Boseko]
            ...
            if (table.getColumnCount() > 0) {
                //Column count == 0 during initialization. [Bob Boseko]
    ...
    private void initTable(Layer layer) {
        ...
        table.setModel(new ColorThemingTableModel(defaultStyle,
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                ...
                //the user tries to move the columns. [Bob Boseko]
                if ((rowIndex == 0)
    ...
    private void jbInit() throws Exception {
        ...
        //Don't get squished by overlong status messages. [Bob Boseko]
    ...
    protected void enableColorThemingCheckBox_actionPerformed(ActionEvent e) {
        if (table.getRowCount() == 1) {
            //1 == just the "All other values" row. [Bob Boseko]
            populateTable();
        }
        updateComponents();
    }
    ...
    void attributeNameComboBox_actionPerformed(ActionEvent e) {
        try {
            ...
            if (selectedItem != null && selectedItem.equals(lastAttributeName)) {
                //Don't want to clear the table if the attribute hasn't changed. [Bob Boseko]
                return;
            }
            initClassificationComboBox(getAttributeType());
            updateComponents();
            ...
            //on the same attribute -- the table is repopulated! [Bob Boseko]
            lastAttributeName = getAttributeName();
            if (table.getModel() instanceof ColorThemingTableModel) {
                //Model will be DefaultTableModel during early initialization. [Bob Boseko]
    ...
    private ColorScheme getColorSchemeForInserts() {
        ...
        //be used for inserts. [Bob Boseko]
    ...
    private boolean setErrorMessage(ErrorMessage message, boolean enabled) {
        ...
        //"specific part" of the error message may be new. [Bob Boseko]
    ...
    private void setState(State state) {
        ...
        try {
            ...
            //the range colour schemes. [Bob Boseko]
    ...
    public static interface State {
        ...
        /**
         * Performs any necessary modifications to the map before applying it to
         * the layer.
         */
