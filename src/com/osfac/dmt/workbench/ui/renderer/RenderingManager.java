...
public class RenderingManager {
     ...
     * may pile up if the server is down. [Bob Boseko]
     */
    ...
    // making rendering appear to be slower. [Bob Boseko]
    ...
    public void render(Object contentID, boolean clearImageCache) {
        ...
        if (runnable != null) {
            ...
            // the system sluggish. [Bob Boseko]
    ...
    public void dispose() {
        ...
        // according to OptimizeIt [Bob Boseko]
    ...
    /**
     * Remove the LayerRenderer when a Layer is removed (helps to free the
     * memory) Added on 2007-05-21 [Michael Michaud and Larry Becker] Called by
     * LayerManager
     *
