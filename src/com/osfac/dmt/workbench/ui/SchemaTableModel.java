...
public class SchemaTableModel extends ColumnBasedTableModel {
    ...
    public static class Field {
        ...
        //of course ignored when the changes are committed. [Bob Boseko]
        ...
        columns.add(new Column(FIELD_NAME_COLUMN_NAME, String.class) {
            ...
            public void setValueAt(Object value, int row) {
                if ((value == null || ((String)value).length() == 0) && get(row).getType() == null) {
                    ...
                    //Don't set the name and especially don't set a default value for the type. [Bob Boseko]
                    return;
                }
        ...
        columns.add(new Column(DATA_TYPE_COLUMN_NAME, AttributeType.class) {
            ...
            public void setValueAt(Object value, int row) {
                if (value == null) {
                    ...
                    //Don't set the type and especially don't set a default value for the name. [Bob Boseko]
                    return;
                }
