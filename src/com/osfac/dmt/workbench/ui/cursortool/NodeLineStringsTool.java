...
public class NodeLineStringsTool extends AbstractClickSelectedLineStringsTool {
    ...
    private final static String sNoIntersectionsHere = I18N.get("com.osfac.dmt.workbench.ui.cursortool.NodeLineStringsTool.No-intersections-here");

    public String getName() {
        return I18N.get("com.osfac.dmt.workbench.ui.cursortool.NodeLineStringsTool.Node-LineStrings");
    }
        ...
        Intersection intersection = closest(getModelClickPoint(),
            ...
            public Object yield(Object intersection) {
                try {
                    ...
                    // Not critical. Eat it. [Bob Boseko
                    // 2004-10-25]
