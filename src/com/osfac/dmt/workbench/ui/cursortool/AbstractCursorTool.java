...
import com.osfac.dmt.workbench.ui.snap.SnapManager;
import com.osfac.dmt.workbench.ui.snap.SnapPolicy;
import com.osfac.dmt.workbench.ui.snap.SnapToFeaturesPolicy;
import com.osfac.dmt.workbench.ui.snap.SnapToGridPolicy;
...
public abstract class AbstractCursorTool implements CursorTool {
    ...
    public void activate(LayerViewPanel layerViewPanel) {
        ...
        if (configuringSnapping && !snappingConfigured) {
            //Must wait until now because #getWorkbench needs the panel to be set. [Bob Boseko]
    ...
    public static WorkbenchFrame workbenchFrame(LayerViewPanel layerViewPanel) {
        ...
        //e.g. LayerViewPanelDemoFrame. [Bob Boseko]
    ...
    private Graphics2D getGraphics2D() {
        ...
        if (g != null) {
            //Not sure why g is null sometimes [Bob Boseko]
    ...
    protected void drawShapeXOR(Shape shape, Graphics2D graphics) {
        ...
        try {
            //Pan tool returns a null shape. [Bob Boseko]
            if (shape != null) {
    ...
    private void redrawShape(Graphics2D graphics) throws Exception {
        ...
        //Might we need synchronization? [Bob Boseko]
    ...
    public static DMTWorkbench workbench(LayerViewPanel panel) {
