 ...
 * as the key is released. For more information, see the book "Humane
 * Interfaces" by Jef Raskin.
 */
public class QuasimodeTool extends DelegatingTool {
    ...
    //in which the default cursor stays only for a split second. [Bob Boseko]
...
//        }
    ...
    public void activate(final LayerViewPanel panel) {
        ...
        if (frame != null) {
            ...
            //WorkbenchFrame is activated (e.g. when a dialog is closed). [Bob Boseko]
...
//        setDelegate(currentKeyEvent != null ? getTool(currentKeyEvent) : getDefaultTool());
    ...
    public static class ModifierKeySpec {
        ...
        public int hashCode() {
            //Map will be small anyway. [Bob Boseko]
            return 0;
        }
