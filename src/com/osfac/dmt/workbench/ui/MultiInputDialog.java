...
public class MultiInputDialog extends AbstractMultiInputDialog {
     ...
     * <ul> <li>For JCheckBox, JRadioButton and JLabel and JPanel the component
     * spreads over 3 columns. Empty label is in the fourth column.</li> <li>For
     * JComboBox and JTextField, label is in first column and component in
     * second column. Third and fourth column or empty.</li> </ul>
     * |---|------------------------|----------------------|-----|---| | 0 | 1 |
     * 2 | 3 | 4 |
     * |---|-----------------------------------------------------|---| | |
    ...
    /**
     * Indent the label of a field with a MatteBorder having the width of a
     * JCheckBox and the color of the component background. This helps to align
     * JCheckBox label (text on the right of the CheckBox) with other component
     * labels (text on the left of the component).
     *
    ...
    public static void main(String[] args) {
        ...
        com.osfac.dmt.feature.FeatureDataset ds1 =
                new com.osfac.dmt.feature.FeatureDataset(fs1);
        ...
        com.osfac.dmt.feature.FeatureDataset ds2 =
                new com.osfac.dmt.feature.FeatureDataset(fs2);
        ...
        com.osfac.dmt.feature.FeatureDataset ds3 =
                new com.osfac.dmt.feature.FeatureDataset(fs3);
        ...
        jcb.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (jcb.isSelected()) {
                    d.infoPanel.setIcon(new ImageIcon(com.osfac.dmt.workbench.ui.images.IconLoader.class.getResource("Butt.gif")));
