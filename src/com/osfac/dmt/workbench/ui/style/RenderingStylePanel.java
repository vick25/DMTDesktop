 ...
 * {@link de.latlon.deejump.plugin.style.DeeRenderingStylePanel}
 */
public class RenderingStylePanel extends BasicStylePanel implements StylePanel {
    ...
    private JPanel previewPanel = new JPanel() {
        ...
        //Enough of a viewport to satisfy the two styles [Bob Boseko]
    ...
    public RenderingStylePanel(Blackboard blackboard, Layer layer) {
        ...
        //Set layer after #jbInit, because both methods initialize the components. [Bob Boseko]
        setLayer(layer);
    }
    ...
    public void updateControls() {
        ...
        if (vertexSlider == null) {
            //Get here during superclass initialization. [Bob Boseko]
            return;
        }
...
//            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));                
    ...
    public void updateStyles() {
        ...
        try {
            ...
            //because one depends on the other. [Bob Boseko]
