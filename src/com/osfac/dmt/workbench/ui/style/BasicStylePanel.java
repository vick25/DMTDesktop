...
import com.osfac.dmt.workbench.ui.renderer.style.BasicFillPattern;
import com.osfac.dmt.workbench.ui.renderer.style.BasicStyle;
import com.osfac.dmt.workbench.ui.renderer.style.FillPatternFactory;
...
public class BasicStylePanel extends JPanel {
    ...
    void updateTexturePaintColor(CustomTexturePaint paint, File file) {
        try {
            ...
            showMessageDialog(getParent(), getMessage(
                    "com.osfac.dmt.workbench.ui.style.BasicStylePanel.error-opening-file", new Object[] { e1
                            .getMessage() }), get("com.osfac.dmt.workbench.ui.style.BasicStylePanel.error"),
                    ERROR_MESSAGE);
        }
    }
    ...
    public void setBasicStyle(BasicStyle basicStyle) {
        ...
        // fill
        // pattern in the combobox. [Bob Boseko]
        ...
        // if the two items are equal but not == . [Bob Boseko]
    ...
    private void addCustomFillPatterns() {
        for (Iterator i = ((Collection) blackboard.get(FillPatternFactory.CUSTOM_FILL_PATTERNS_KEY, new ArrayList()))
            ...
            if (null == findEquivalentItem(fillPattern, fillPatternComboBox)) {
                ...
                // collection of
                // custom fill patterns [Bob Boseko]
