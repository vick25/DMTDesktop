...
import com.osfac.dmt.workbench.driver.AbstractDriver;
...
//buttons. But I remember there was a reason for this. Revisit this design. [Bob Boseko]
public class DriverDialog extends JDialog implements ActionListener {
    ...
    public boolean wasOKPressed() {
        if (!closeInitiatedByPanelButton) {
            //The dialog's close button was pressed instead. [Bob Boseko]
            return false;
        }
    ...
    private DriverPanelCache driverPanelCache(Layer layer) {
        //e.g. open dialog will have no layer set. [Bob Boseko]
        if (layer == null) {
