...
import com.osfac.dmt.workbench.model.*;
import com.osfac.dmt.workbench.ui.cursortool.CursorTool;
import com.osfac.dmt.workbench.ui.cursortool.DummyTool;
import com.osfac.dmt.workbench.ui.cursortool.LeftClickFilter;
import com.osfac.dmt.workbench.ui.cursortool.QuasimodeTool;
import com.osfac.dmt.workbench.ui.renderer.RenderingManager;
import com.osfac.dmt.workbench.ui.renderer.java2D.Java2DConverter;
import com.osfac.dmt.workbench.ui.renderer.style.PinEqualCoordinatesStyle;
...
//panels are in a GridLayout or SplitPane). [Bob Boseko]
/**
...
public class LayerViewPanel extends JPanel
    ...
    public LayerViewPanel(LayerManager layerManager,
        ...
        //Errors occur if the LayerViewPanel is sized to 0. [Bob Boseko]
        setMinimumSize(new Dimension(100, 100));

        //Set toolTipText to null to disable, "" to use default (i.e. show all
        // attributes),
        //or a custom template. [Bob Boseko]
        setToolTipText("");
        ...
        try {
            ...
            addMouseListener(new MouseAdapter() {
                public void mouseEntered(MouseEvent e) {
                    ...
                    // happen because the
                    //WorkbenchFrame does not have focus. [Bob Boseko]
                    //JavaDoc for #toFront says some platforms will not
                    // activate the window.
                    //So use #requestFocus instead. [Bob Boseko 12/9/2003]
    ...
    //inactive internal frame, it won't work. [Bob Boseko]
    ...
    public static boolean intersects(Geometry a, Geometry b) {
        ...
        for (Iterator i = aComponents.iterator(); i.hasNext();) {
            ...
            // work for
            //polygons and zero-length vectors. [Bob Boseko]
    ...
    public Image createBlankPanelImage() {
        ...
        //from scratch instead of calling #createImage. [Bob Boseko]
        return new BufferedImage(getWidth(), getHeight(), BufferedImage.TYPE_INT_ARGB);
    }

    public void repaint() {
        if (renderingManager == null) {
            //It's null during initialization [Bob Boseko]
            superRepaint();
    ...
    private void initializeViewportIfNecessary() throws NoninvertibleTransformException {
        ...
        //now considers only visible layers [Bob Boseko 2004-06-18]
    ...
    protected String format(double d, double pixelWidthInModelUnits) {
        ...
        //An extra decimal place, for good measure [Bob Boseko]
        String formatString = "#.";
    ...
    //Not sure where this method should reside. [Bob Boseko]
    ...
    /**
     * @param millisecondDelay the GUI will be unresponsive for this length of
     * time, so keep it short!
     */
            ...
            GUIUtil.invokeOnEventThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        // Hopefully the user
                        //won't Alt-Tab away and back! [Bob Boseko]
    ...
    public void flash(final GeometryCollection geometryCollection) throws NoninvertibleTransformException {
