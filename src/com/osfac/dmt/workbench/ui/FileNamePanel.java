...
public class FileNamePanel extends JPanel {
    ...
    //cache in the JCS Workbench properties file [Bob Boseko]
    ...
    public File getSelectedFile() {
        ...
        //when we call #addToComboBox. [Bob Boseko]
    ...
    //takes a minute or so to open. [Bob Boseko]
    private File browse() {
    ...
    private void addToComboBox(File file, DefaultComboBoxModel comboBoxModel) {
        ...
        //gets moved to the top [Bob Boseko]
