...
/**
 * At the bottom-left corner is an MS-Access-style record navigator for cycling
 * through the history of documents. A new document is created when
 * #createNewDocument is called. <P> Methods can be called regardless of whether
 * or not the current thread is the AWT event dispatching thread.
 */
...
public class HTMLFrame extends JInternalFrame {
    ...
    /**
     * Appends a line of non-HTML text to the frame. Text is assumed to be
     * non-HTML, and is HTML-escaped to avoid control-char conflict.
     *
     * @param text
     */
