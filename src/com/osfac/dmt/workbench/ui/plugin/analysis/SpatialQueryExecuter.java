...
/**
 * Exceutes a spatial query with a given mask FeatureCollection, source
 * FeatureCollection, and predicate. Ensures result does not contain duplicates.
 *
 * @author Martin Davis
 * @version 1.0
 */
...
//  private GeometryPredicate predicate;
    ...
    /**
     * Gets the featurec collection to query. This may be indexed if this would
     * improve performance.
     *
     * @param func
     * @return
