...
public class ViewSchemaPlugIn extends AbstractPlugIn {
    ...
    private void applyChanges(final Layer layer, final SchemaPanel panel)
        ...
        if (!panel.isModified()) {
            ...
            //Don't truncate the undo history; instead, exit. [Bob Boseko]
            return;
        }
        ...
        //Two-phase commit. Phase 1: check that no conversion errors occur. [Bob Boseko]
    ...
    private void commitEditsInProgress(final SchemaPanel panel) {
        //Skip if nothing is being edited, otherwise may get false positive. [Bob Boseko]
