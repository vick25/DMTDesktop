...
public class DualPaneInputDialog extends MultiInputDialog {
    ...
    public static void main(String[] args) {
        ...
        d.addComboBox("Metier", "Cadre", Arrays.asList("Cadre","Charpentier","Maeon","Boulanger"), "");
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (d.getDescriptionPanel().getDescription().equals("")) {
                    d.setSideBarDescription("Description de la boite de dialogue et des paramètres pour aider l'utilisateur");
