...
public class AttributeTab extends JPanel implements LayerNamePanel {
    ...
    //The only thing checked is whether they are null or not. [Bob Boseko]
                    ...
                    public void layerAdded(LayerTableModel layerTableModel) {
                        ...
                        MouseListener mouseListener = new MouseAdapter() {
                            public void mouseReleased(MouseEvent e) {
                                ...
                                //call #getSelectedLayers. [Bob Boseko]                                        
        ...
        layerManagerProxy.getLayerManager().addLayerListener(new LayerListener() {
            ...
            public void layerChanged(LayerEvent e) {
                if (e.getType() == LayerEventType.METADATA_CHANGED) {
                    //Editability may have changed. [Bob Boseko]
                    toolBar.updateEnabledState();
                }
            }
    ...
    private void installToolBarButtons(final WorkbenchContext workbenchContext, final TaskFrame taskFrame) {
         ...
         * toolBar.add( new JButton(), myReplacePlugIn.getName(),
         * GUIUtil.toSmallIcon(ReplaceValuePlugIn.ICON),
         * ReplaceValuePlugIn.toActionListener(myReplacePlugIn,
         ...
         * toolBar.addSeparator();
         *
         * StatisticOverViewPlugIn statisticOverViewPlugIn = new
         * StatisticOverViewPlugIn(); toolBar.add( new JButton(),
         * statisticOverViewPlugIn.getName(),
         * GUIUtil.toSmallIcon(IconLoader.icon("statistics.png")),
         * StatisticOverViewPlugIn.toActionListener(statisticOverViewPlugIn,
         * workbenchContext, null), new
    ...
    private void zoom(AttributePanel.Row row) throws NoninvertibleTransformException {
        ...
        if (row.isFirstRow()) {
            //Make header visible [Bob Boseko]
    ...
    private static PlugIn wrap(final PlugIn plugIn) {
        ...
        //AbstractButton#fireActionPerformed). [Bob Boseko]
        return new PlugIn() {
            ...
            public boolean execute(PlugInContext context) throws Exception {
                //Save attributeTab before executing plug-in, as it may change active window. [Bob Boseko]
