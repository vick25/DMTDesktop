...
import com.osfac.dmt.util.SimpleStringEncrypter;
...
public class ConnectionDescriptor
{
  ...
  public int hashCode() {
    ...
    // ConnectionDescriptors [Bob Boseko 2005-03-07]
    return 0;
  }
  ...
  private boolean equals(ConnectionDescriptor other) {
    if (!(other instanceof ConnectionDescriptor)) {
      // This case includes null. [Bob Boseko 2005-03-16]
      return false;
        }
