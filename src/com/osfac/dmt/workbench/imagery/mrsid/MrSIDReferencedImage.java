package com.osfac.dmt.workbench.imagery.mrsid;
...
public class MrSIDReferencedImage implements ReferencedImage{
	...
	public void paint(Feature f, Graphics2D g, Viewport viewport) throws DMTException {
        ...
        else
        {
            ...
            if (!((rwSidFileRightEdge <= rwViewLeft) || (rwSidFileLeftEdge >= rwViewRight) || (rwSidFileTopEdge <= rwViewBot) || (rwSidFileBotEdge >= rwViewTop)))
            {
                ...
                {
                	t.printStackTrace();
                	throw new DMTException(t.getMessage());
                }
            }
        }
	}
