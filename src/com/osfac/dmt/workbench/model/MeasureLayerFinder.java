...
public class MeasureLayerFinder extends SystemLayerFinder {
    ...
    /**
     * Builds a new Feature from a Geometry with the given FeatureSchema. This
     * Feature can later be added to Layer.
     *
     * @param measureGeometry
     * @param schema
     * @return a new Feature having measureGeometry as Geometry and schema as
     * FeatureSchema
     */
