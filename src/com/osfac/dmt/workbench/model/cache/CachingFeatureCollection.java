package com.osfac.dmt.workbench.model.cache;
...
import com.osfac.dmt.util.LazyList;
import com.osfac.dmt.util.ListWrapper;
 ...
 */
// The cache is a ThreadSafeFeatureCollection. [Bob Boseko 2005-03-04]
...
//    private static final FeatureCollection DUMMY_CACHED_FEATURE_COLLECTION = AddNewLayerPlugIn.createBlankFeatureCollection();
    ...
    public CachingFeatureCollection(final FeatureCollection featureCollection) {
        ...
        // This is not used very often though. [Bob Boseko 2005-03-03]
	...
	/**
	 * @see com.osfac.dmt.feature.FeatureCollectionWrapper#getEnvelope()
	 */
	...
	/**
	 * @see com.osfac.dmt.feature.FeatureCollectionWrapper#getFeatureSchema()
	 */
    ...
    public List query(final Envelope envelope) {
        ...
        // LazyList and ListWrapper. [Bob Boseko 2005-03-22]
        ...
        return new ListWrapper() {
            ...
            public Iterator iterator() {
                // Caching criterion 1: envelope check [Bob Boseko 2005-03-22]
                if (cachingByEnvelope
                        && envelopeOfCompletedCache.contains(envelope)) {
                    return super.iterator();
                }
                // Caching criterion 2: GUI-thread check [Bob Boseko 2005-03-22]
                ...
                return new Iterator() {
                    ...
                    public Object next() {
                        ...
                        if (!hasNext()) {
                            ...
                            // complete. [Bob Boseko 2005-03-03]
    ...
    private void initializeCacheIfNecessary() {
        ...
        // i.e. until FeatureCollection#query is called [Bob Boseko
        // 2005-03-04]
        // Example: DynamicFeatureCollection [Bob Boseko 2005-03-22]
        if (initialized) {
            return;
        }
