 ...
 * {@link com.osfac.dmt.io.datasource.DataSourceQuery DataSourceQueries}
 * each of which encapsulates a query string and the DataSource to run it
 * against.
 *
 *
 */
public interface DataSourceQueryChooser {
    ...
    /**
     * @return a brief description of the dataset type, suitable for display in
     * a combo box.
     */
