...
public class Validator {
    ...
    //<<TODO:REFACTORING>> Move this class and associated classes to JTS [Bob Boseko]
    public Validator() {
    }
     ...
     *
     * @param checkingBasicTopology whether basic JTS validation should be
     * performed
     */
     ...
     * validation error.
     *
     * @param minPolygonArea the threshould used by the minimum-polygon-area
     * check
     ...
     *
     * @param checkingMinAngle whether to enforce the constraint that angle
     * should be no less than the minimum
     ...
     *
     * @param checkingMinPolygonArea whether to enforce the constraint that area
     * should be no less than the minimum, for single polygons and polygon
     ...
     * @param validationErrors a List of ValidationError's to add to if the
    ...
    private ValidationError validateMinSegmentLength(Coordinate[] coordinates,
        ...
        for (int i = 1; i < coordinates.length; i++) { //Start at 1 [Bob Boseko]
