 ...
 * interface:<br> </p> <p> <table border='1' cellspacing='0' cellpadding='4'>
 * <tr> <th>Parameter</th><th>Meaning</th> </tr> <tr> <td>OutputFile or
 * DefaultValue</td> <td>File name for output .xml file</td> </tr> <tr>
 * <td>OutputTemplateFile</td> <td>File name for GMLOutputTemplate file</td>
 * </tr> </table><br> </p> NOTE: If OutputTemplateFile is unspecified, one will
 * be auto-created (the JCS format). <br> <br> Programmer details: <br> <br>
 ...
 * </pre> <br>
 *
 * Also, the function "makeOutputTemplate()" is useful for autogenerating the
 * JCS outputtemplate. <br> <br>
 *
 * Output will be formed from the OutputTeplate like:<Br> <br>
 * <pre>
 * headerText
...
public class GMLWriter implements JUMPWriter {
    ...
    /**
     * Actual evaluator/writer - you should have already called
     * setOutputTemplate
     *
     * @param featureCollection features to write
    ...
    /**
     * Convert an arbitary string into something that will not cause XML to
     * gack. Ie. convert "<" to "&lt;"
     *
