 ...
 *
 * <p> DataProperties for the ShapefileWriter write(DataProperties)
 * interface:<br><br> </p>
 *
 * <p> <table border='1' cellspacing='0' cellpadding='4'> <tr>
 * <th>Parameter</th> <th>Meaning</th> </tr> <tr> <td>OutputFile or
 * DefaultValue</td> <td>File name for the output .shp file</td> </tr> <tr>
 * <td>ShapeType</td> <td> Dimentionality of the Shapefile - 'xy', 'xym' or
 * 'xyz'. 'xymz' and 'xyzm' are the same as 'xyz' </td> </tr> </table><br>
 *
 * <p> NOTE: The input .dbf and .shx is assumed to be 'beside' (in the same
 * directory) as the .shp file. </p>
 *
 * The shapefile writer consists of two parts: writing attributes (.dbf) and
 * writing geometries (.shp).
 *
 * <p> JUMP columns are converted to DBF columns by: </p>
 *
 * <table border='1' cellspacing='0' cellpadding='4'> <tr> <th>JUMP Column</th>
 * <th>DBF column</th> </tr> <tr> <td>STRING</td> <td>Type 'C' length is size of
 * longest string in the FeatureCollection </td> </tr> <tr> <td>DOUBLE</td>
 * <td>Type 'N' length is 33, with 16 digits right of the decimal</td> </tr>
 * <tr> <td>INTEGER</td> <td>Type 'N' length is 16, with 0 digits right of the
 * decimal</td> </tr> </table>
 *
 *
 ...
 * </p>
 *
 * <p> Since shape files may contain only one type of geometry (POINT,
 * MULTPOINT, POLYLINE, POLYGON, POINTM, MULTPOINTM, POLYLINEM, POLYGONM,
 * POINTZ, MULTPOINTZ, POLYLINEZ, or POLYGONZ), the FeatureCollection must be
 * first be normalized to one type: </p>
 *
 * <table border='1' cellspacing='0' cellpadding='4'> <tr> <th>First non-NULL
 * non-Point geometry in FeatureCollection</th> <th>Coordinate
 * Dimensionality</th> <th>Shape Type</th> </tr> <tr> <td> MULTIPOINT </td> <td>
 * xy xym xyzm </td> <td> MULTIPOINT MULTIPOINTM MULTIPOINTZ </td> </tr> <tr>
 * <td> LINESTRING/MULTILINESTRING </td> <td> xy xym xyzm </td> <td> POLYLINE
 * POLYLINEM POLYLINEZ </td> </tr> <tr> <td> POLYGON/MULTIPOLYGON </td> <td> xy
 * xym xyzm </td> <td> POLYGON POLYGONM POLYGONZ </td> </tr> <tr> <th>All
 * geometries in FeatureCollection are</th> <th>Coordinate Dimensionality</th>
 * <th>Shape Type</th> </tr> <tr> <td> POINT </td> <td> xy xym xyzm </td> <td>
 * POINT POINTM POINTZ </td> </tr> </table>
 *
 * <p> During this normalization process any non-consistent geometry will be
 * replaced by a NULL geometry. </p>
 *
 * <p> For example, if the shapetype is determined to be 'POLYLINE' any POINT,
 * MULTIPOINT, or POLYGON geometries in the FeatureCollection will be replaced
 * with a NULL geometry. </p>
 *
 * <p> The coordinate dimensionality can be explicitly set with a DataProperties
 * tag of 'ShapeType': 'xy', 'xym', or 'xyz' ('xymz' and 'xyzm' are pseudonyms
 * for 'xyz'). If this DataProperties is unspecified, it will be auto set to
 * 'xy' or 'xyz' based on the first non-NULL geometry having a Z coordinate.
 * </p>
 *
 * <p> Since JUMP and JTS do not currently support a M (measure) coordinate, it
 * will always be set to �10E40 in the shape file (type 'xym' or 'xyzm'). This
 * value represents the Measure "no data" value (page 2, ESRI Shapefile
 * Technical Description). Since the 'NaN' DOUBLE values for Z coordinates is
 * invalid in a shapefile, it is converted to '0.0'. </p>
 *
 ...
 * Shapefile Spec</a> </p>
 *
 * <TODO> The link referencing the DBF format specification is broken - fix
 * it!</TODO>
 *
 */
public class ShapefileWriter implements JUMPWriter {
     ...
     * @param dp 'OutputFile' or 'DefaultValue' to specify where to write, and
     * 'ShapeType' to specify dimentionality.
     */
    ...
    /**
     * Returns: <br> 2 for 2d (default) <br> 4 for 3d - one of the oordinates
     * has a non-NaN z value <br> (3 is for x,y,m but thats not supported yet)
     * <br>
     *
    ...
    /**
     * Write a dbf file with the information from the featureCollection. For
     * compatibilty reasons, this method is is now a wrapper for the changed/new
     * one with Charset functions.
     *
     * @see writeDbf(FeatureCollection featureCollection, String fname, Charset
     * charset)
     *
     ...
     * @param fname name of the dbf file to write to July 2, 2010 - modified by
     * beckerl to read existing dbf file header and use the existing numeric
     * field definitions.
     */
     ...
     * 0 : only empty geometry collection <br> 1 : only single points<br> 3 : at
     * least one line or multiline<br> 5 : at least one polygon or multipolygon
     * <br> 8 : at least one multipoint<br> 31 : only non empty geometry
     * collection<br>
     *
    ...
    /**
     * return a single geometry collection <Br> result.GeometryN(i) = the i-th
     * feature in the FeatureCollection<br> All the geometry types will be the
     * same type (ie. all polygons) - or they will be set to<br> NULL
     * geometries<br> <br> GeometryN(i) = {Multipoint,Multilinestring, or
     * Multipolygon)<br>
     *
