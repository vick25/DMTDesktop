 ...
 *
 * <p> This is a simple class that passes the work off to the {@link GMLReader }
 * class which already has support for auto-generating a JML input template (see
 * {@link GMLInputTemplate}). </p>
 *
 * <p> DataProperties for the JMLReader load(DataProperties) interface:<br><br>
 * </p>
 *
 * <table border='1' cellspacing='0' cellpadding='4'> <tr> <th>Parameter</th>
 * <th>Meaning</th> </tr> <tr> <td>File or DefaultValue</td> <td>File name for
 * the input JML file</td> </tr> <tr> <td>CompressedFile</td> <td> File name (a
 * .zip or .gz) with a .jml/.xml/.gml inside (specified by File) </td> </tr>
 * <tr> <td>CompressedFileTemplate</td> <td> File name (.zip or .gz) with the
 * input template in (specified by InputTemplateFile) </td> </tr> </table> <br>
 * <br>
 */
