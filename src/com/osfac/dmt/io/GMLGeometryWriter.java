...
/**
 * Writes or creates a formatted string containing the GML representation of a
...
public class GMLGeometryWriter {
    ...
    /**
     * Returns a
     * <code>String</code> of repeated characters.
     *
    ...
    /**
     * Sets the
     * <code>srsName</code> attribute to be output on the Geometry element. If
     * <code>null</code> no attribute will be output.
     *
     * @param srsName
     */
    ...
    /**
     * Sets the
     * <code>gid</code> attribute to be output on the Geometry element. If
     * <code>null</code> no attribute will be output.
     *
