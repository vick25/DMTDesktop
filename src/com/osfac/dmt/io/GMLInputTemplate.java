...
public class GMLInputTemplate extends DefaultHandler {
    ...
    com.osfac.dmt.feature.AttributeType columnDef_type = null;
    ...
    public Object getColumnValue(int index, String tagBody, Attributes xmlAtts)
        ...
        if (cd.type == AttributeType.INTEGER) {
            try {
                ...
                //values didn't fit in an Integer. [Bob Boseko 1/13/2004]
                ...
                //this null business -- future: warn the user. [Bob Boseko 1/13/2004]
                try {
        ...
        //occurs or if the type is unrecognized? [Bob Boseko]
    ...
    public void endElement(String uri, String name, String qName)
        ...
        try {
            ...
            if (qName.equalsIgnoreCase("type")) {
                ...
                try {
                    columnDef_type = com.osfac.dmt.feature.AttributeType.toAttributeType(t);
                } catch (IllegalArgumentException e) {
                    //Hmm...we're just eating the exception here. Perhaps we should
                    //allow the exception to propagate up to the caller. [Bob Boseko]
                    columnDef_type = null;
                }
            }
