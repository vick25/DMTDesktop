 ...
 *
 * <p> This is a simple class that passes the work off to the {@link GMLWriter}
 * class that knows how to auto-generate a JML compatible
 * {@link GMLOutputTemplate}. </p>
 *
 * <p> DataProperties for the JMLWriter write(DataProperties) interface:<br><br>
 * </p>
 *
 * <p> <table border='1' cellspacing='0' cellpadding='4'> <tr>
 * <th>Parameter</th> <th>Meaning</th> </tr> <tr> <td>OutputFile or
 * DefaultValue</td> <td>File name for the output JML file</td> </tr>
 * </table><br> </p>
 */
