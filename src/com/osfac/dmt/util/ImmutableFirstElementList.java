...
public class ImmutableFirstElementList implements List {
    ...
    public Iterator iterator() {
    	//Prevent Iterator#remove. [Bob Boseko]
    ...
    public boolean remove(Object o) {
    	//An element equal to the first element may exist later in the list. [Bob Boseko] 
    ...
    public List subList(int fromIndex, int toIndex) {
    	...
    	//to be modified, moved, or removed. [Bob Boseko]
