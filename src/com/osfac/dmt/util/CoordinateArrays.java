...
public class CoordinateArrays {
    ...
    //I wonder if we should collapse this class into that one. [Bob Boseko]
    ...
    //delegate to the other. [Bob Boseko]
     ...
     * @param desiredOrientation CGAlgorithms.CLOCKWISE or
    ...
    /**
     * Extract the coordinate arrays for a geometry. Polygons will be checked to
     * ensure their rings are oriented correctly. Note: coordinates from Points
     * or MultiPoints will not be extracted.
     *
     * @param g the Geometry to extract from
