...
//have better error reporting. [Bob Boseko]
public class XMLBinder {
    ...
    protected boolean specifyingTypeExplicitly(Class c)
        ...
        //The int and double classes are abstract. Filter them out. [Bob Boseko]
        if (hasCustomConverter(c)) {
            return false;
        }

        //In the handling of Maps, c may be the Object class. [Bob Boseko]
