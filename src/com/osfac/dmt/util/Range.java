...
public class Range {
    ...
    //serialized via Java2XML. [Bob Boseko]
    public static final class NegativeInfinity {
        public String toString() {
            // Empty string, for range display in TreeLayerNamePanel. [Bob Boseko 2005-07-25]
            return "";
        }
    }
    ...
    //Trivial, but necessary for Java2XML serialization. [Bob Boseko]
