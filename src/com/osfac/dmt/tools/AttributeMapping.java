...
public class AttributeMapping {
     ...
     *
     * @param a schema for first feature collection from which to transfer
     * attributes
     * @param b schema for second feature collection from which to transfer
     * attributes
     */
     ...
     * @param aAttributeNames non-spatial feature-collection-A attributes to
     * transfer
     * @param aNewAttributeNames corresponding names in the feature collection
     * receiving the attributes
     * @param bSchema metadata for feature-collection B
     * @param bAttributeNames non-spatial feature-collection-B attributes to
     * transfer
     * @param bNewAttributeNames corresponding names in the feature collection
     * receiving the attributes
     */
    ...
    public static class CombinedSchema extends FeatureSchema {
        ...
        public int toAOldAttributeIndex(int newAttributeIndex) {
            return ((Integer) aNewToOldAttributeIndexMap.get(new Integer(newAttributeIndex))).intValue();
        }

        public int toBOldAttributeIndex(int newAttributeIndex) {
            return ((Integer) bNewToOldAttributeIndexMap.get(new Integer(newAttributeIndex))).intValue();
        }
