...
public class NoderPlugIn extends AbstractThreadedUiPlugIn {
    ...
    public void run(TaskMonitor monitor, PlugInContext context) throws Exception {
        ...
        if (do_not_process_lines && do_not_process_polygons) {
            ...
            Map<Feature, Map<Integer, Map<Integer, List<SegmentString>>>> geomStructureMap = SegmentStringsWithData2Features
            ...
            if (update_selected_features) {
                ...
                context.getWorkbenchFrame().warnUser(I18N.get("jump.plugin.edit.NoderPlugIn.no-output-data"));
            }
        }
     ...
     * segment. This method is for detection only. It uses a floating point
     * precision model and as a consequence, it is not 100% robust.
     *
     ...
     * points of the LineStrings. This method is for detection only. It uses a
     * floating point precision model and as a consequence, it is not 100%
     * robust.
     *
     * @param segmentStrings SegmentStrings to process
     * @param intersector SegmentIntersector to collect intersection information
