...
public class FilterQuery implements Query {
    ...
    public void setFilterGeometry(Geometry geom) {
        this.geom = geom;
    }
    ...
    /**
     * Sets the SpatialReferenceSystem for a query. This is optional; whether it
     * is required depends on the datastore implemention. Datastore drivers may
     * set this themselves and override any user settings.
     *
