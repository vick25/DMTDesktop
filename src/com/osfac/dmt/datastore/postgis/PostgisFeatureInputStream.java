...
import com.osfac.dmt.io.BaseFeatureInputStream;
import java.sql.*;
...
public class PostgisFeatureInputStream extends BaseFeatureInputStream {
    ...
    /**
     * @return The underlaying {@link Statement}. Useful to cancel the query on
     * the server if the PlugIn is interrupted
     */
