...
public class Triangle {
    ...
    /**
     * Returns the area of the triangle. See
     * http://www.mathcs.emory.edu/~rudolf/math108/summ1-2-3/node7.html
     *
    ...
    public boolean contains(Coordinate p) {
        ...
        //is not robust (see TriangulatorTestCase#testContains2) [Bob Boseko]

        //Can't simply use != because if one is 1 and the other is 0 that's OK. [Bob Boseko]
    ...
    /**
     * Returns the three triangles that result from splitting this triangle at a
     * given point.
     *
    ...
    public Coordinate toSimplicialCoordinate(Coordinate euclideanCoordinate) {
        //<<TODO>> Preserve the z-coordinate [Bob Boseko]
     ...
     *
     * @param simplicialCoordinate the simplicial coordinate, which uses x, y,
     * and z
     ...
     * @return the first simplicial coordinate for the given Euclidean
     * coordinate
     */
     ...
     *
     * @param c a Euclidean coordinate
     * @return the second simplicial coordinate for the given Euclidean
     * coordinate
     */
